 ...
 *
 */
public class QueryGrowthRateBean extends BaseDAO {
	
	public QueryGrowthRateBean(SessionManager session, ResourceBundle bundle) {
		...
		while(tk.hasMoreTokens()){
			...
			if("ProductionVol".equals(variable) || "HarvestedArea".equals(variable) || "ProductionCost".equals(variable)){
				...
				sql = " select distinct" +
						"	yo.prod_id prodId, \n" +
						"	trim(yo.prod_desc) prodDesc\n" +
						getPriceQuery(initialDate, finalDate, countries, null, null, null);
			}
	...
	public String getVarietiesCollection(String variable, String periods, String countries, String prodId) throws Exception, Error {
		String sql = new String();
		String sqlGlobal = new String();
		String initialDate = new String(), finalDate= new String();
		...
		while(tk.hasMoreTokens()){
			...
			if("PromedioXUnidad".equals(variable)){
				...
				sql = " select distinct" +
						...
						getPriceQuery(initialDate, finalDate, countries, prodId, null, null);
			}
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public String getQualitiesCollection(String variable, String periods, String countries, String prodId, String varId) throws Exception, Error {
		String sql = new String();
		String sqlGlobal = new String();
		String initialDate = new String(), finalDate= new String();
		...
		while(tk.hasMoreTokens()){
			...
			if("PromedioXUnidad".equals(variable)){
				...
				sql = " select distinct" +
						...
						getPriceQuery(initialDate, finalDate, countries, prodId, varId, null);
			}
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public String getSizesCollection(String variable, String periods, String countries, String prodId, String varId, String quaId) throws Exception, Error {
		String sql = new String();
		String sqlGlobal = new String();
		String initialDate = new String(), finalDate= new String();
		...
		while(tk.hasMoreTokens()){
			...
			if("PromedioXUnidad".equals(variable)){
				...
				sql = " select distinct" +
						...
						getPriceQuery(initialDate, finalDate, countries, prodId, varId, quaId);
			}
		...
		while(tk.hasMoreTokens()){
			...
			if("ProductionVol".equals(variable) || "HarvestedArea".equals(variable) || "ProductionCost".equals(variable)){
				...
				sql = " select distinct" +
						...
						"	yo.ctr_desc ctrDescSpa,\n" +
						"	yo.ctr_desc_eng ctrDescEng\n" +
						getPriceQuery(initialDate, finalDate, null, null, null, null);
			}
	...
	private String getPriceQuery(String initialDate, String finalDate, String countries, String prodId, String varId, String quaId){
		String sql = new String();
