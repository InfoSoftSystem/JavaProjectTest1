...
<tiles:insert name="plantillaBase" definition="plantillaBase">
	...
	<tiles:put name="help" type="String">
		Mide el desempeño del comercio de un país para un producto, en relación con el resto de mercancías y el resto del mundo. 
		Se puede realizar un análisis comparativo en el tiempo y con varios productos para ver como evoluciona su competitividad.
		<br/>
		<br/>
		Si selecciona por producto, puede seleccionar varias frutas para comparar sus índices. 
		Si selecciona por categoría, puede seleccionar la categoría de frutas frescas congeladas, 
		para hacer un análisis agregado del índice.
		<br/>
		<br/>
		<b>Fuente metodológica</b>:Joaquín Arias y Oswaldo Segura, especialistas del IICA
		<br/>
		<br/>
		<b>Fuente de datos</b>:
		FAOSTAT: exportaciones e importaciones de frutas por país. COMTRADE: exportaciones e importaciones totales (todos los rubros) por país y el mundo
	</tiles:put>
