...
<tiles:insert name="plantillaBase" definition="plantillaBase">
	...
	<tiles:put name="help" type="String">
		<b>Costos de Establecimiento</b>: se refieren a los costos para establecer la plantación previo a que ésta se encuentre en producción
		<br/>
		<b>Costos de mantenimiento</b>:  se refieren a los costos incurridos durante el cultivo está en producción.
		<br/>
		<br/>
			...
			*/
			...
			Ext.onReady(function(){
				...
				var storeCountries = Ext.create('Ext.data.Store', {
			        ...
			        proxy: {
			            type: 'ajax',
			            url: 'queryProductionCostAction.do?accion=loadCountries',
			            reader: {
			            	type: 'json',
			                root: 'registers'
			            }
				...
				var storeProducts = Ext.create('Ext.data.Store', {
			        ...
			        proxy: {
			            type: 'ajax',
			            url: 'queryProductionCostAction.do?accion=loadProducts',
			            reader: {
			            	type: 'json',
			                root: 'registers'
			            }
				...
				var cstFormPanel = Ext.create('Ext.custom.FormPanel',{
					...
					labelWidth: 85,
					width: 550,
					title: '<bean:message key="queryProductionCost.header" />',
					items: [
				    {
      	        		xtype:'hidden',
      	        		id:'countriesDesc',
      	        		...
      	        		id:'report',
      	        		name:'report',
      	        		value: '04_costo_produccion.jrxml'
      	        	},{
      	        		xtype:'hidden',
      	        		id:'FormatPrint',
      	        		name:'FormatPrint',
						...
						{
	      	              	xtype: 'combo',
	      	                fieldLabel: '<bean:message key="queryProductionCost.initialDate"/>',
	      	                id:'initialDate',
	      	                name: 'initialDate',
	      	                //maxLength: 1,
	      	              	allowBlank:false,
	      	              	//width: 200,
	      	              	blankText:'<bean:message key="queryProductionCost.initialDate.required"/>',
					        ...
					        listeners:{
	      	              	...
	      	              	xtype: 'combo',
	      	                fieldLabel: '<bean:message key="queryProductionCost.finalDate"/>',
	      	                id:'finalDate',
	      	                name: 'finalDate',
	      	                //maxLength: 1,
	      	              	allowBlank:false,
	      	              	//width: 200,
	      	              	blankText:'<bean:message key="queryProductionCost.finalDate.required"/>',
					        store: 	Ext.create('Ext.data.Store',{
					        	model: 'modelYearSk',
					        	data: {registers: <%=request.getAttribute("yearsCollection")%>},
					        	proxy:{
					        ...
					        listeners:{
	      	        		...
	      	        		margin: '10 0 0 0',
	      	        		align:'middle',
	      	        		text:'<bean:message key="queryProductionCost.countries.available" />'
	      	        	},{
	      	        		xtype:'label',
	      	        		baseCls:'x-form-item-label',
	      	        		margin: '10 0 0 0',
	      	        		align:'middle',
	      	        		text:'<bean:message key="queryProductionCost.countries.selected" />'
	      	        	},{
	      	        		colspan:2,
	      	        		xtype: 'container',
      	                    layout: 'fit',
      	                    ...
      	                    items: [{
					            ...
					            id: 'countries',
					            hideLabel: true,
					            blankText: '<bean:message key="queryProductionCost.countries.selected.required"/>',
					            buttons:["add", "remove"],
	      	        		...
	      	        		margin: '10 0 0 0',
	      	        		align:'middle',
	      	        		text:'<bean:message key="queryProductionCost.product.available" />'
	      	        	},{
	      	        		xtype:'label',
	      	        		baseCls:'x-form-item-label',
	      	        		margin: '10 0 0 0',
	      	        		align:'middle',
	      	        		text:'<bean:message key="queryProductionCost.product.selected" />'
	      	        	},{
	      	        		colspan:2,
	      	        		xtype: 'container',
      	                    layout: 'fit',
      	                    ...
      	                    items: [{
					            ...
					            id: 'products',
					            hideLabel: true,
					            blankText: '<bean:message key="queryProductionCost.product.selected.required"/>',
					            buttons:["add", "remove"],
					            store: storeProducts,
	        	            ...
	        	            disabled:true,
	        	            xtype: 'button',
	      	            	text: '<bean:message key="queryProductionCost.showReport" />',
	      	            	width: 100,
	        	          	listeners: {
								click: function(){
				...
				function validateRange(){
               		...
               		if(initialDate > finalDate){
               			tmpMsg = tmpMsg+'<bean:message key="queryProductionCost.finalDate.minor"/>';
               		}
	...
	<tiles:put name="title" type="String">
		<bean:message key="queryProductionCost.title" />
	</tiles:put>

	<tiles:put name="encabezado" type="String">
		<bean:message key="queryProductionCost.header" />
	</tiles:put>
