...
<tiles:insert name="plantillaBase" definition="plantillaBase">
			...
			*/
			...
			Ext.onReady(function(){
				...
				var storeCountries = Ext.create('Ext.data.Store', {
			        ...
			        proxy: {
			            type: 'ajax',
			            url: 'queryProductionVolumeAction.do?accion=loadCountries',
			            reader: {
			            	type: 'json',
			                root: 'registers'
			            }
				...
				var storeProducts = Ext.create('Ext.data.Store', {
			        ...
			        proxy: {
			            type: 'ajax',
			            url: 'queryProductionVolumeAction.do?accion=loadProducts',
			            reader: {
			            	type: 'json',
			                root: 'registers'
			            }
				...
				var cstFormPanel = Ext.create('Ext.custom.FormPanel',{
					...
					labelWidth: 85,
					width: 550,
					title: '<bean:message key="queryProductionVolume.header" />',
					items: [
				    {
      	        		xtype:'hidden',
      	        		id:'countriesDesc',
      	        		...
      	        		id:'report',
      	        		name:'report',
      	        		value: '03_volumen_produccion.jrxml'
      	        	},{
      	        		xtype:'hidden',
      	        		id:'FormatPrint',
      	        		name:'FormatPrint',
						...
						{
	      	              	xtype: 'combo',
	      	                fieldLabel: '<bean:message key="queryProductionVolume.initialDate"/>',
	      	                id:'initialDate',
	      	                name: 'initialDate',
	      	                //maxLength: 1,
	      	              	allowBlank:false,
	      	              	//width: 200,
	      	              	blankText:'<bean:message key="queryProductionVolume.initialDate.required"/>',
					        ...
					        listeners:{
	      	              	...
	      	              	xtype: 'combo',
	      	                fieldLabel: '<bean:message key="queryProductionVolume.finalDate"/>',
	      	                id:'finalDate',
	      	                name: 'finalDate',
	      	                //maxLength: 1,
	      	              	allowBlank:false,
	      	              	//width: 200,
	      	              	blankText:'<bean:message key="queryProductionVolume.finalDate.required"/>',
					        store: 	Ext.create('Ext.data.Store',{
					        	model: 'modelYearSk',
					        	data: {registers: <%=request.getAttribute("yearsCollection")%>},
					        	proxy:{
					        ...
					        listeners:{
	      	        		...
	      	        		margin: '10 0 0 0',
	      	        		align:'middle',
	      	        		text:'<bean:message key="queryProductionVolume.countries.available" />'
	      	        	},{
	      	        		xtype:'label',
	      	        		baseCls:'x-form-item-label',
	      	        		margin: '10 0 0 0',
	      	        		align:'middle',
	      	        		text:'<bean:message key="queryProductionVolume.countries.selected" />'
	      	        	},{
	      	        		colspan:2,
	      	        		xtype: 'container',
      	                    layout: 'fit',
      	                    ...
      	                    items: [{
					            ...
					            id: 'countries',
					            hideLabel: true,
					            blankText: '<bean:message key="queryProductionVolume.countries.selected.required"/>',
					            buttons:["add", "remove"],
	      	        		...
	      	        		margin: '10 0 0 0',
	      	        		align:'middle',
	      	        		text:'<bean:message key="queryProductionVolume.product.available" />'
	      	        	},{
	      	        		xtype:'label',
	      	        		baseCls:'x-form-item-label',
	      	        		margin: '10 0 0 0',
	      	        		align:'middle',
	      	        		text:'<bean:message key="queryProductionVolume.product.selected" />'
	      	        	},{
	      	        		colspan:2,
	      	        		xtype: 'container',
      	                    layout: 'fit',
      	                    ...
      	                    items: [{
					            ...
					            id: 'products',
					            hideLabel: true,
					            blankText: '<bean:message key="queryProductionVolume.product.selected.required"/>',
					            buttons:["add", "remove"],
					            store: storeProducts,
	        	            ...
	        	            disabled:true,
	        	            xtype: 'button',
	      	            	text: '<bean:message key="queryProductionVolume.showReport" />',
	      	            	width: 100,
	        	          	listeners: {
								click: function(){
				...
				function validateRange(){
               		...
               		if(initialDate > finalDate){
               			tmpMsg = tmpMsg+'<bean:message key="queryProductionVolume.finalDate.minor"/>';
               		}
	...
	<tiles:put name="title" type="String">
		<bean:message key="queryProductionVolume.title" />
	</tiles:put>

	<tiles:put name="encabezado" type="String">
		<bean:message key="queryProductionVolume.header" />
	</tiles:put>
